//
//  SettingsCharityPreferenceTableViewCell.swift
//  HiU
//
//  Created by Pranshi on 8/4/18.
//  Copyright © 2018 developer. All rights reserved.
//

import UIKit

class SettingsCharityPreferenceTableViewCell: UITableViewCell {
    ...
    var settingsCharityPreferenceitem: SettingsCharityPreferences?{
        didSet{
            guard let item = settingsCharityPreferenceitem else {
                return
            }
